            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('cours.update', $cours->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            <label for="id_enseignant" class="block text-gray-700 text-sm font-bold mb-2">
                                Enseignant <span class="text-red-500">*</span>
                            </label>
                            <select
                                id="id_enseignant"
                                name="id_enseignant"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('id_enseignant') border-red-500 @enderror"
                            >
