<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Modifier un Créneaux de l\'Emploi du Temps') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('timetable.update', $emploiDuTemp->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            >
                                ...
                                @foreach($classes as $classe)
                                    <option value="{{ $classe->id }}" {{ old('classe_id', $emploiDuTemp->classe_id) == $classe->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input
                                    ...
                                    id="heure_debut"
                                    name="heure_debut"
                                    value="{{ old('heure_debut', $emploiDuTemp->heure_debut) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="heure_fin"
                                    name="heure_fin"
                                    value="{{ old('heure_fin', $emploiDuTemp->heure_fin) }}"
                        ...
                        <div class="mb-6">
                            ...
                            >
                                ...
                                @foreach($matieres as $matiere)
                                    <option value="{{ $matiere->id }}" {{ old('matiere_id', $emploiDuTemp->matiere_id) == $matiere->id ? 'selected' : '' }}>
                                        {{ $matiere->nom }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-6">
                            ...
                            >
                                ...
                                @foreach($enseignants as $enseignant)
                                    <option value="{{ $enseignant->id }}" {{ old('enseignant_id', $emploiDuTemp->enseignant_id) == $enseignant->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                ...
                                id="salle"
                                name="salle"
                                value="{{ old('salle', $emploiDuTemp->salle) }}"
